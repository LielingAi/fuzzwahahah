...
import CRT  // Windows (ucrt): pow 等数学函数
#endif
...
extension PoolStateMachine {
    ...
    static func calculateBackoff(failedAttempt attempts: Int) -> Duration {
        ...
        // Windows Swift 6.3: 显式 Int64 避免 Range<Float16> 推断 bug
        let jitterValue: Int64 = Int64((-jitterRange...jitterRange).randomElement()!)
        let jitter: Duration = .nanoseconds(jitterValue)
